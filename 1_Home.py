...
with st.sidebar:
    selected = option_menu("Menú Principal", ["Inicio",'Rendimiento Jugadores','Jugadores Similares','Rendimiento Equipos','Equipos Similares'], 
        icons=['house','lightning','diagram-3-fill','bar-chart-line','distribute-vertical'], menu_icon="cast", default_index=0)
    selected
